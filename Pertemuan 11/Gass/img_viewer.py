...
#  ],
 [
 sg.Text("+/-  Darken to Brightness"),
 
 ],
 [
 sg.Slider(range=(-100,100), default_value=(1), enable_events=True, orientation='h', s=(15,8), key="value_penjumlahan"),
#  sg.Button("Brightness", size=(10, 1), key="PenjumlahanCitra"),
...
list_processing = [
 ...
 [
 sg.Button("Edge Detector", size=(7, 1), key="EdgeDetector"),
 ],
 [
 sg.Button("Gaussian", size=(7, 1), key="ImgGausian"),
 ],
 [
 sg.Button("Sharpen", size=(7, 1), key="ImgSharpen"),
 ],
 [
 sg.Button("Erosi", size=(7, 1), key="ImgErosi"),
 sg.Button("Dilasi", size=(7, 1), key="ImgDilasi"),
 ],
 [
 sg.Button("Opening", size=(7, 1), key="ImgOpening"),
 sg.Button("Closing", size=(7, 1), key="ImgClosing"),
 ],
 [
 sg.Button("White Top Hat", size=(7, 1), key="ImgWhiteTopHat"),
 sg.Button("Black Top Hat", size=(7, 1), key="ImgBlackTopHat"),
 ],
...
#         pass
 ...
 elif event == "EdgeDetector": 
    try:
        value = int (values['value_filter'])
        window["ImgProcessingType"].update("Edge Detector") 
        img_output= EdgeDetector(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass

 elif event == "ImgGaussion": 
    try:
        value = int (values['value_filter'])
        window["ImgProcessingType"].update("Image Gaussion") 
        img_output= ImgGaussion(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass
    ...
    try:
        ...
        img_output= ImgSharpen(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass
    ...
    try:
        ...
        img_output= ImgErosi(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass
    ...
    try:
        ...
        img_output= ImgDilasi(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass
    ...
    try:
        ...
        img_output= ImgOpening(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass
    ...
    try:
        ...
        img_output= ImgClosing(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass
    ...
    try:
        value = int (values['value_filter'])
        window["ImgProcessingType"].update("Image White Top Hat") 
        img_output= ImgWhiteTopHat(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass
    ...
    try:
        value = int (values['value_filter'])
        window["ImgProcessingType"].update("Image Black Top Hat") 
        img_output= ImgBlackTopHat(img_input,coldepth, value) 
        img_output.save(filename_out) 
        window["ImgOutputViewer"].update(filename=filename_out) 
    except: 
        pass
